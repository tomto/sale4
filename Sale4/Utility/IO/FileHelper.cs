...
namespace Utility.IO
{
    ...
    public class FileHelper
    {
        ...
        /// Creates the file.
        /// Author:CHENHEGANG
        /// CreateDate:2014-09-23 16:07:04
        /// </summary>
        ...
        public static string ReadFileContent(string filePath)
        {
            ...
            try
            {
                sw = new StreamReader(filePath, Encoding.UTF8);
        ...
        /// <returns><c>true</c> if [is exist directory] [the specified directory path]; otherwise, <c>false</c>.</returns>
        ...
        /// <returns><c>true</c> if [is exist file] [the specified file path]; otherwise, <c>false</c>.</returns>
        ...
        /// </summary>
        /// <param name="directoryPath">指定目录的绝对路径</param>
        /// <returns><c>true</c> if [is empty directory] [the specified directory path]; otherwise, <c>false</c>.</returns>
        ...
        /// <param name="searchPattern">模式字符串，"*"代表0或N个字符，"?"代表1个字符。
        /// 范例："Log*.xml"表示搜索所有以Log开头的Xml文件。</param>
        /// <returns><c>true</c> if [contains] [the specified directory path]; otherwise, <c>false</c>.</returns>
